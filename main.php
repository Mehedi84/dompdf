...
<th style="border: 1px solid black">Vat Taka</th>
...
while ($row = mysqli_fetch_assoc($sql)) {
	...
	<td style="border: 1px solid black;text-align: center;">'.$vatTk.'</td>
...
<tr>
<td style="border: 1px solid black;"><strong>Amount In Words: '.numberTowords($totalGrandTotal).'  BDT</strong></td>
</tr>
</table>';
if ($invoice["vat_text"]!='') {
